...
static EWRAM_DATA bool8 sDescriptionSumbenu = 0;
...
static void HandleInputChooseMove(void)
{
    ...
    if (JOY_NEW(A_BUTTON) && !sDescriptionSumbenu)
    {
        u8 moveTarget;
    ...
    else if ((JOY_NEW(B_BUTTON) || gPlayerDpadHoldFrames > 59) && !sDescriptionSumbenu)
    {
        PlaySE(SE_SELECT);
    ...
    else if (JOY_NEW(SELECT_BUTTON) && !sDescriptionSumbenu)
    {

...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_DEOXYS_NORMAL]  = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_DEOXYS_ATTACK]  = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  1 },
    [SPECIES_DEOXYS_DEFENSE] = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_DEOXYS_SPEED]   = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  0 },

...
const u32 gMonStillFrontPic_DeoxysNormal[] = INCBIN_U32("graphics/pokemon/deoxys/normal/front.4bpp.lz");
const u32 gMonPalette_DeoxysNormal[] = INCBIN_U32("graphics/pokemon/deoxys/normal/normal.gbapal.lz");
const u32 gMonBackPic_DeoxysNormal[] = INCBIN_U32("graphics/pokemon/deoxys/normal/back.4bpp.lz");
const u32 gMonShinyPalette_DeoxysNormal[] = INCBIN_U32("graphics/pokemon/deoxys/normal/shiny.gbapal.lz");
const u8 gMonIcon_DeoxysNormal[] = INCBIN_U8("graphics/pokemon/deoxys/normal/icon.4bpp");
